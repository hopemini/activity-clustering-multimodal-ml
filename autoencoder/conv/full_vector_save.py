...
all_path = data_path + "/image/all_dir"

## Set data loader
dataset = datasets.ImageFolder(root=all_path,
...
def run(_iter):
    ...
    data_name = "conv_" + ("re" if types == "real" else "se")
    ...
    save_path = "../../full_data/" +data_name + "_" + str(_iter) + "/"
